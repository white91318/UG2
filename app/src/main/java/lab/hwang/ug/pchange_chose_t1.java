...
public class pchange_chose_t1 extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.pchange_chose_trapezoidal);
        findview();
        ...
        sure_But1.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View v) {
...

                {
                    ...
                    new AlertDialog.Builder(pchange_chose_t1.this)
                            .setCancelable(false)
                            .setTitle("選擇是否正確??")
                            .setMessage("選擇正確的答案!!!")
                            .setPositiveButton("確認",new DialogInterface.OnClickListener(){
                                public void onClick(DialogInterface dialog, int which)
                                {
                                    ...
                                    //儲存sqlite
                                    dbHelper = new SQLite(pchange_chose_t1.this, "practice_recorde_data");
                ...
                {
                    dbHelper = new SQLite(pchange_chose_t1.this, "record_action");
