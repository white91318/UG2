...
public class change_chose_r extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.change_chose_rectangle);
        ...
        sure_But1.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                {
			     				/*
			     				dbHelper = new SQLite(change_chose_r.this, "record_action");
				  				dbHelper.Insert_Action(login.practice_page,"practice_ok_To_session2_record");
				  				dbHelper.close();//關閉資料庫
				  				*/

                    new AlertDialog.Builder(change_chose_r.this)
                            .setCancelable(false)
                            .setTitle("選擇是否正確??")
                            .setMessage("選擇正確的答案!!!")
                            .setPositiveButton("確認",new DialogInterface.OnClickListener(){
                                public void onClick(DialogInterface dialog, int which)
                                {
                                    ...
                                    //儲存sqlite
                                    dbHelper = new SQLite(change_chose_r.this, "practice_recorde_data");
