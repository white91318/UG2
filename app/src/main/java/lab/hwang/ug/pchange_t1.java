...
public class pchange_t1 extends Activity implements ViewSwitcher.ViewFactory {
    ...
    private static final Integer[] imagelist = {R.drawable.ppt1, R.drawable.ppt2};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(pchange_t1.this,pchange_chose_t1.class);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            if (next_one_activity2.switch_practice_homework.equals("homework")) {
                ...
                new AlertDialog.Builder(pchange_t1.this)
                        .setTitle("警告")
