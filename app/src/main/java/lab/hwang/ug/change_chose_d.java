...
public class change_chose_d extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.change_chose_diamond);
        findview();
        ...
        sure_But1.setOnClickListener(new Button.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if (checkedId == radio_But2.getId()){
                    ...
                    new AlertDialog.Builder(change_chose_d.this)
                            .setCancelable(false)
                            .setTitle("選擇是否正確??")
                            .setMessage("選擇正確的答案!!!")
                            .setPositiveButton("確認",new DialogInterface.OnClickListener(){
                                public void onClick(DialogInterface dialog, int which)
                                {
                                    ...
                                    //儲存sqlite
                                    dbHelper = new SQLite(change_chose_d.this, "practice_recorde_data");
                                    dbHelper.close();//關閉資料庫
                                    change_chose_d.this.finish();
                                }
                            })
                            .show();
                }else
                {
                    dbHelper = new SQLite(change_chose_d.this, "record_action");
