...
public class change_p extends Activity implements ViewSwitcher.ViewFactory {
    ...
    private static final Integer[] imagelist = {R.drawable.p1, R.drawable.p2, R.drawable.p3,
            R.drawable.p4,R.drawable.p5,R.drawable.p6,R.drawable.p7,R.drawable.p8};

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.change_paralle);
        findview();
        ...
        chose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(change_p.this,change_chose_p.class);
    ...
    private void findview() {
        // TODO Auto-generated method stub
        chose=(Button)findViewById(R.id.chose_but_p1);
        forward = (Button) findViewById(R.id.forward_p1);
        next = (Button) findViewById(R.id.next_p1);
        switcher = (ImageSwitcher) findViewById(R.id.imageSwitcher1_p1);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            if (next_one_activity2.switch_practice_homework.equals("homework")) {
                ...
                new AlertDialog.Builder(change_p.this)
                        .setTitle("警告")
