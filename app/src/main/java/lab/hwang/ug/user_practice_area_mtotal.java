...
public class user_practice_area_mtotal extends Activity {
    //class
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.user_practice_area_mtotal);
        findview();
        Create_practice_record_list();

        sdf = new SimpleDateFormat("HHmmss");//日期
        tempsdf = sdf.format(new Date());
        process_store_name=measure_session4_makeup.temp_pic_storename+tempsdf;

        bitmap = BitmapFactory.decodeFile("/sdcard/file_data/"+measure_session4_makeup.temp_pic_storename);
        ...
        final ProgressDialog PDialog = ProgressDialog.show(user_practice_area_mtotal.this, "請稍後", "導入練習資訊", true);
        new Thread(){
            public void run(){
                try{
                    sleep(2000);
        ...
        //一開始顯示形狀的概念
				/*Intent intent = new Intent();
		 		...
		 		intent.setClass(user_practice_area_mtotal.this, show_large_image_makeup.class);
        ...
        but_back.setOnClickListener(new Button.OnClickListener()
        {
            ...
            {
                Intent intent = new Intent();
                intent.setClass(user_practice_area_mtotal.this, concept_area2.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        pen_size.setOnClickListener(new Button.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                new AlertDialog.Builder(user_practice_area_mtotal.this)//選擇顯示圖示
                        .setTitle("請選擇鉛筆粗細")
                ...
                new AlertDialog.Builder(user_practice_area_mtotal.this)
                        ...
                        .setPositiveButton("確認",new DialogInterface.OnClickListener(){
                            public void onClick(DialogInterface dialog, int which)
                            {
                                ...
                                String object_pic = measure_session4_makeup.temp_pic_storename;

                                long no = dbHelper.InsertSubmit_Homework_one
                                        (concept_area2.user_id,       //1
                                                concept_area2.measure_shap="total_concept",   //2
    ...
    private Cursor Get_practice_record_listCursor(String table_name) {
        // TODO Auto-generated method stub
        dbHelper = new SQLite(user_practice_area_mtotal.this, table_name);
                    ...
                    .setPositiveButton("確認",new DialogInterface.OnClickListener(){
                        public void onClick(DialogInterface dialog, int which)
                        {
                            if(practice_record_m.from_practice_record_page)
                            {
					  				...
					  				*/
                                Intent intent = new Intent();
                                intent.setClass(user_practice_area_mtotal.this, practice_record_m.class);
                                startActivity(intent);
                                user_practice_area_mtotal.this.finish();
                            }else
                            {
