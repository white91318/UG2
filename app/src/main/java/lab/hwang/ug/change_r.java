...
public class change_r extends Activity implements ViewSwitcher.ViewFactory {
    ...
    private static final Integer[] imagelist = {R.drawable.r0, R.drawable.r1, R.drawable.r2,
            R.drawable.r3 };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                intent.setClass(change_r.this,change_chose_r.class);
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_BACK) {
            if (next_one_activity2.switch_practice_homework.equals("homework")) {
                ...
                new AlertDialog.Builder(change_r.this)
                        .setTitle("警告")
