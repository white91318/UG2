...
public class practice_precord extends Activity {
    //class
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back_home.setOnClickListener(new Button.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                dbHelper = new SQLite(practice_precord.this, "see_practice_record");
                dbHelper.see_record("leave");
                dbHelper.close();//關閉資料庫

                practice_precord.this.finish();
            }
        });
    }
    ...
    private Cursor Get_practice_record_listCursor(String table_name) {
        ...
        dbHelper = new SQLite(practice_precord.this, table_name);
    ...
    private void Show_practice_record_list(Cursor cursor) {
        ...
        if(cursor !=null){
            ...
            while(cursor.moveToNext()){
                ...
                {
                    calculate_process[i]="正確的算式:\n( "+stu_calculate_value1[i]+"  "+stu_calculate_operand1[i]+"  "+stu_calculate_value2[i]+" )  X 2 =  "+ stu_calculate_ans[i];
        ...
        All_practice_listview.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, final int arg2,
                ...
                new AlertDialog.Builder(practice_precord.this)//選擇顯示圖示
                        .setTitle("請選擇您需要的功能")
                                    ...
                                    public void onClick(DialogInterface dialog, int whichcountry)
                                    {
                                        switch (whichcountry) {
                                            case 0:
                                                ...
                                                intent.setClass(practice_precord.this, show_large_image.class);
